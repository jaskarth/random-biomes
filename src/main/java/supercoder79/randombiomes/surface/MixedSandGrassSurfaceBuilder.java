...
public class MixedSandGrassSurfaceBuilder extends SurfaceBuilder<TernarySurfaceConfig> {
    double threshold = 0;
    public MixedSandGrassSurfaceBuilder(Function<Dynamic<?>, ? extends TernarySurfaceConfig> function_1, double threshold) {
        super(function_1);
    ...
    public void generate(Random random, Chunk chunk, Biome biome, int int_1, int int_2, int int_3, double noise, BlockState blockState_1, BlockState blockState_2, int int_4, long long_1, TernarySurfaceConfig config) {
        if (noise > threshold) {
            SurfaceBuilder.DEFAULT.generate(random, chunk, biome, int_1, int_2, int_3, noise, blockState_1, blockState_2, int_4, long_1, SurfaceBuilder.GRASS_CONFIG);
        } else {
