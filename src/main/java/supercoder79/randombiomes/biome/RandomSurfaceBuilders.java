...
import supercoder79.randombiomes.surface.MixedSandRedSandSurfaceBuilder;
...
public class RandomSurfaceBuilders {
    ...
    public static MixedSandRedSandSurfaceBuilder MIXED_SAND;
    ...
    public static void init() {
        ...
        MIXED_SAND = Registry.register(Registry.SURFACE_BUILDER,
                new Identifier("randombiomes", "msrs"),
                new MixedSandRedSandSurfaceBuilder(TernarySurfaceConfig::deserialize, 0));
